...
import uk.co.nesbit.crypto.merkle.DefaultHashDigestProvider
...
internal class MerkleTreeImpl(
    ...
    override fun createAuditProof(leafIndices: List<Int>): MerkleProofImpl {
    ...
    override fun consistencyProof(oldTreeSize: Int): List<SecureHash> {
