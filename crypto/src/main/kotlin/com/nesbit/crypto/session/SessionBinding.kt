...
class SessionBinding(val otherPartyNonce: ByteArray,
    ...
    companion object {
        val sessionBindingSchema: Schema = Schema.Parser().addTypes(mapOf(VersionedIdentity.versionedIdentitySchema.fullName to VersionedIdentity.versionedIdentitySchema,
                PublicKeyHelper.publicKeySchema.fullName to PublicKeyHelper.publicKeySchema)).parse(SessionBinding::class.java.getResourceAsStream("/com/nesbit/crypto/session/sessionbinding.avsc"))
