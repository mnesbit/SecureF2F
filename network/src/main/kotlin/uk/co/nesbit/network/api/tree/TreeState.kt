...
class TreeState(
    ...
    companion object {
        ...
        const val TimeErrorPerHop = 10000L
        ...
        fun createTreeState(
            ...
            val now = clock.instant().truncatedTo(ChronoUnit.MILLIS) // round to prevent round trip problems
            val nowBytes = now.toEpochMilli().toByteArray()
            ...
            val pathList = prevPath + SecurePathItem(now, from, signatureOverNext)
...
//            }
//            require(timeDiff <= BaseTimeError + index * TimeErrorPerHop) {
